...
async function analyzeTicker(
  ...
  try {
    ...
    // Accuracy-first target: conservative blend of drift and one-month uncertainty band.
    ...
    // Final composite ranking score (confidence-first, projected upside second).
